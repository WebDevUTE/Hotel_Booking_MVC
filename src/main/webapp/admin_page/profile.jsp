			...
			<ul class="nav user-menu">
				<li class="nav-item dropdown has-arrow">
					...
					<div class="dropdown-menu">
						...
						</div> <a class="dropdown-item" href="profile.html">My Profile</a>  <a class="dropdown-item" href="logout">Logout</a> </div>
				</li>
			</ul>
		</div>
									...
									<div class="col-lg-6">
										<div class="card">
											<div class="card-body">
												...
												<div class="row mt-5">
													<p class="col-sm-3 text-sm-right mb-0 mb-sm-3">Hotel Name</p>
													<p class="col-sm-9">Tên của hotel</p>
												</div>
												<div class="row">
													<p class="col-sm-3 text-sm-right mb-0 mb-sm-3">Description</p>
													<p class="col-sm-9">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eos voluptas aut sapiente officia. Suscipit commodi deleniti nostrum, cupiditate, quo, quam laborum doloremque iusto corrupti consectetur voluptates fugit dolorum deserunt totam!</p>
												</div>
												<div class="row">
													<p class="col-sm-3 text-sm-right mb-0 mb-sm-3">Email Hotel </p>
												...
												<div class="row">
													<p class="col-sm-3 text-sm-right mb-0 mb-sm-3">Mobilephone Hotel</p>
													<p class="col-sm-9">305-310-5857</p>
												</div>
												<div class="row">
													<p class="col-sm-3 text-sm-right mb-0">Address</p>
													<p class="col-sm-9 mb-0">4663 Agriculture Lane, Miami,
														Florida - 33165,
														United States.</p>
												</div>
											</div>
